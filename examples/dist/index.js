(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["ReactCheckboxTree"] = factory();
	else
		root["ReactCheckboxTree"] = factory();
...
var _nanoid = __webpack_require__(125);

var _nanoid2 = _interopRequireDefault(_nanoid);

var _TreeNode = __webpack_require__(127);
    ...
    _createClass(CheckboxTree, [{
        ...
        value: function onCheck(node) {
            var _props = this.props,
                ...
                onlyCascadeDown = _props.onlyCascadeDown,
        ...
        key: 'getCheckState',
        value: function getCheckState(node, noCascade, onlyCascadeDown) {
        ...
        key: 'toggleChecked',
        value: function toggleChecked(node, isChecked, noCascade, onlyCascadeDown) {
            var _this3 = this;
            ...
            if (noCascade && onlyCascadeDown) {
                ...
                if (node.children !== null) {
                    node.children.forEach(function (child) {
                        _this3.toggleChecked(child, isChecked, noCascade, onlyCascadeDown);
                    });
                }
            } else {
                // Original code 
...
CheckboxTree.propTypes = {
    ...
    onlyCascadeDown: _propTypes2.default.bool,
...
var _BasicExample = __webpack_require__(53);

var _BasicExample2 = _interopRequireDefault(_BasicExample);

var _OnlyCascadeDownExample = __webpack_require__(128);

var _OnlyCascadeDownExample2 = _interopRequireDefault(_OnlyCascadeDownExample);

var _CustomIconsExample = __webpack_require__(129);

var _CustomIconsExample2 = _interopRequireDefault(_CustomIconsExample);

var _DisabledExample = __webpack_require__(130);

var _DisabledExample2 = _interopRequireDefault(_DisabledExample);

var _NoCascadeExample = __webpack_require__(131);

var _NoCascadeExample2 = _interopRequireDefault(_NoCascadeExample);

var _PessimisticToggleExample = __webpack_require__(132);

var _PessimisticToggleExample2 = _interopRequireDefault(_PessimisticToggleExample);

var _LargeDataExample = __webpack_require__(133);

var _LargeDataExample2 = _interopRequireDefault(_LargeDataExample);
...
_reactDom2.default.render(_react2.default.createElement(_OnlyCascadeDownExample2.default, null), document.getElementById('only-cascade-down-example'));
_reactDom2.default.render(_react2.default.createElement(_CustomIconsExample2.default, null), document.getElementById('custom-icons-example'));
...
_reactDom2.default.render(_react2.default.createElement(_NoCascadeExample2.default, null), document.getElementById('no-cascade-example'));
...
_reactDom2.default.render(_react2.default.createElement(_LargeDataExample2.default, null), document.getElementById('large-data-example'));
...
*/
var aa=__webpack_require__(0),l=__webpack_require__(22),B=__webpack_require__(6),C=__webpack_require__(3),ba=__webpack_require__(23),da=__webpack_require__(24),ea=__webpack_require__(25),fa=__webpack_require__(26),ia=__webpack_require__(27),D=__webpack_require__(8);
...
var _reactCheckboxTree = __webpack_require__(4);
...
var BasicExample = function (_React$Component) {
    ...
    _createClass(BasicExample, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(_reactCheckboxTree2.default, {
                checked: checked,
                expanded: expanded,
                nodes: nodes,
...
var OnlyCascadeDownExample = function (_React$Component) {
    _inherits(OnlyCascadeDownExample, _React$Component);

    function OnlyCascadeDownExample() {
        _classCallCheck(this, OnlyCascadeDownExample);

        var _this = _possibleConstructorReturn(this, (OnlyCascadeDownExample.__proto__ || Object.getPrototypeOf(OnlyCascadeDownExample)).call(this));
        ...
        _this.state = {
            ...
            // ],
            checked: [],
            expanded: ['/app', '/app/Http', '/app/Http/Controllers', '/app/Providers', '/config', '/public', '/public/assets/']
        };
    ...
    _createClass(OnlyCascadeDownExample, [{
        key: 'onCheck',
        value: function onCheck(checked) {
            this.setState({ checked: checked });
        }
        ...
        value: function render() {
            ...
            return _react2.default.createElement(_reactCheckboxTree2.default, {
                ...
                onCheck: this.onCheck,
                onExpand: this.onExpand,
                onlyCascadeDown: true,
                noCascade: true
            });
        }
    }]);

    return OnlyCascadeDownExample;
}(_react2.default.Component);

exports.default = OnlyCascadeDownExample;
...
var nodes = [{
    ...
    children: [{
        ...
        icon: _react2.default.createElement('i', { className: 'fa fa-file-archive-o' })
    }, {
        value: 'Expense Report.pdf',
        label: 'Expense Report.pdf',
        icon: _react2.default.createElement('i', { className: 'fa fa-file-pdf-o' })
    }, {
        value: 'notes.txt',
        label: 'notes.txt',
        icon: _react2.default.createElement('i', { className: 'fa fa-file-text-o' })
    }]
}, {
    value: 'Photos',
    label: 'Photos',
    children: [{
        value: 'nyan-cat.gif',
        label: 'nyan-cat.gif',
        icon: _react2.default.createElement('i', { className: 'fa fa-file-image-o' })
    }, {
...
var CustomIconsExamples = function (_React$Component) {
    _inherits(CustomIconsExamples, _React$Component);

    function CustomIconsExamples() {
        _classCallCheck(this, CustomIconsExamples);

        var _this = _possibleConstructorReturn(this, (CustomIconsExamples.__proto__ || Object.getPrototypeOf(CustomIconsExamples)).call(this));
...
exports.default = CustomIconsExamples;
...
var NoCascadeExample = function (_React$Component) {
    _inherits(NoCascadeExample, _React$Component);

    function NoCascadeExample() {
        _classCallCheck(this, NoCascadeExample);

        var _this = _possibleConstructorReturn(this, (NoCascadeExample.__proto__ || Object.getPrototypeOf(NoCascadeExample)).call(this));
...
exports.default = NoCascadeExample;
...
var LargeDataExample = function (_React$Component) {
    _inherits(LargeDataExample, _React$Component);

    function LargeDataExample() {
        _classCallCheck(this, LargeDataExample);

        var _this = _possibleConstructorReturn(this, (LargeDataExample.__proto__ || Object.getPrototypeOf(LargeDataExample)).call(this));
...
exports.default = LargeDataExample;
